...
def encrypt(pkA, m, r3=0):
    ...
    # Begin Modification
    beta = r3 if r3 else 0 #random_unit(B) # determines isogeny kernel
    # End Modification
...
# MODIFICATIONS
# 1. Removed timestamp / benchmarking code
# 2. Cleaned up and focused solely on first set of params in POKE_PKE.sage. Attack should work on all of them
# 3. Changed encrypt to allow setting r value